...
!!! note
- The arcade *Side by Side* titles does not support coinage to be set to free play. (Not current sure if other Taito JC System games have a similar limitation.)
